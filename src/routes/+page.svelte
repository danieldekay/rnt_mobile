<script lang="ts">
    ...
    const groupedEventsWithGeo = $derived.by(() =>
    ...
    const musicCounts = $derived.by(() => {
        const counts: Record<MusicType, number> = {
            traditional: 0,
            mixed: 0,
            neo: 0,
        };
    ...
    function getPopupDate(event: TribeEvent): string {
        return formatDayAndMonth(event.start_date);
    }
    ...
    function getPopupTime(event: TribeEvent): string {
        ...
        return formatTimeRange(event.start_date, event.end_date);
    }

    function buildPopupContent(group: GroupedMapEvents): string {
        const heading = escapeHtml(
            group.venueName || "Veranstaltungen an diesem Ort",
        );
    ...
    function handleTypeToggle(type: EventType) {
        const nextState = $eventStore.filters.types.includes(type)
            ? "off"
            : "on";
...
<div class="page-stack">
    ...
    <!-- Filters -->
    <div class="space-y-3">
        <div class="space-y-2" aria-label="Datum und Ansicht">
            ...
            >
                ...
                <div class="flex flex-wrap gap-2 lg:justify-end">
                    ...
                    >
                        ...
                        >
                            <path
                                d="M28,26H4a2.0023,2.0023,0,0,1-2-2V8A2.0023,2.0023,0,0,1,4,6H28a2.0023,2.0023,0,0,1,2,2V24A2.0023,2.0023,0,0,1,28,26ZM4,8V24H28.0012L28,8Z"
                            ></path>
                            <path
                                d="M8 12A2 2 0 1 0 10 14 2.0025 2.0025 0 0 0 8 12zM6 22l5-6 3 4 4-5 6 7H6z"
                            ></path>
                        </svg>
                        <span>Bilder</span>
                    </button>
        ...
        <div class="space-y-2">
            ...
            <div class="relative">
                ...
                <input
                    ...
                    oninput={(e) =>
                        eventStore.setSearchQuery(e.currentTarget.value)}
    ...
    {#if showInlineLoading}
        ...
        >
            <div
                class="h-4 w-4 animate-spin rounded-full border-2 border-action-secondary border-t-action-primary"
            ></div>
    ...
    {#if $eventStore.loading && $eventStore.events.length === 0}
        ...
        >
            <div
                class="mb-4 h-12 w-12 animate-spin rounded-full border-4 border-action-secondary border-t-action-primary"
            ></div>
    ...
    {:else if $eventStore.error}
        ...
        <div class="card space-y-3 p-5 text-center" role="alert">
            ...
            <button onclick={handleRefresh} class="btn-primary" type="button">
                Erneut versuchen
            </button>
        </div>
    ...
    {:else if !showMap}
        ...
        <div class="relative">
            ...
            <div class="mt-6 flex justify-center">
                ...
                >
                    <svg
                        class="h-4 w-4 {$eventStore.loading
                            ? 'animate-spin'
                            : ''}"
                        fill="none"
                        stroke="currentColor"
            ...
            <ListFooterNavigation
                ...
                onLoadMore={$eventStore.canLoadMore
                    ? handleLoadNextRange
                    : null}
