# Capability: Legal Pages

## Purpose

Describe how users open core legal documents inside the app, read mirrored content from the canonical WordPress source, and retain access to the original source references.

## Requirements

### Requirement: Provide in-app access to the main legal documents
The app SHALL provide in-app routes for Impressum, Datenschutzerklaerung, and Cookie-Richtlinie so users can read the legal information without leaving the app.
