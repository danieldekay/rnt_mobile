# Capability: PWA Update Flow

## Purpose

Describe how the app detects a newer deployed build, lets users refresh into it from inside the app, and provides recovery guidance when an installed session still looks stale.
